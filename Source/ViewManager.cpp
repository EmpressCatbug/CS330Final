...
void ViewManager::ProcessKeyboard(Camera_Movement direction, float deltaTime) {
	g_pCamera->ProcessKeyboard(direction, deltaTime);
}

/***********************************************************
 *  ProcessMouseMovement()
 *
 *  This method processes mouse movement for camera orientation.
 ***********************************************************/
void ViewManager::ProcessMouseMovement(float xoffset, float yoffset, GLboolean constrainPitch) {
	g_pCamera->ProcessMouseMovement(xoffset, yoffset, constrainPitch);
}

/***********************************************************
 *  ProcessMouseScroll()
 *
 *  This method processes mouse scroll for zoom adjustment.
 ***********************************************************/
